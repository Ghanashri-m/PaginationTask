var data = [
  ...
  function getNumberOfPages() {
    numberOfPages = Math.ceil(data.length / recordsPerPage);
  }
  ...
  function getSelectedData() {
    ...
    selectedData = data.slice(start, end);
    displayData();
    check();
  }
  ...
  function displayData() {
    ...
    for (i = 0; i < selectedData.length; i++) {
      ...
      td1.innerHTML = selectedData[i].id;
      var td2 = document.createElement("td");
      td2.innerHTML = selectedData[i].name;
      var td3 = document.createElement("td");
      td3.innerHTML = selectedData[i].email;
